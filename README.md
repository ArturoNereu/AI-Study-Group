...
- [Attention in transformers, step-by-step](https://youtu.be/eMlx5fFNoYc?si=Jr--CL_jgoct_QMy) Another 3Blue1Brown video, this one focusing specifically on the Attention mechanism in the Transformer model. A wonderful explanation on the inner workings.
...
| Platforms | - [**Lambda**](https://lambda.ai/): Computing resources for rent for training and inferencing.|
...
A good dataset to start with, is [🍷 FineWeb](https://huggingface.co/datasets/HuggingFaceFW/fineweb). Used to train [nanochat](https://github.com/karpathy/nanochat), among other models.
